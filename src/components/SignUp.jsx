  ...
  return (
    <div className='vh-100 vw-100 d-flex align-items-center justify-content-center'>
        <div className='d-flex align-items-center justify-content-centre flex-column gap-2'>
            <h1 className='d-flex align-items-center justify-content-centre font-weight-bold'>SignUp</h1>
            ...
            <button type="button" class="btn btn-primary btn-block w-100 mt-3">SignUp</button>
